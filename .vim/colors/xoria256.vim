...
hi Normal	cterm=none	ctermfg=252	ctermbg=0	gui=none	guifg=#d0d0d0	guibg=#000000
...
hi StatusLine	cterm=none	ctermfg=bg	ctermbg=67	gui=none	guifg=bg	guibg=#afdfff
hi StatusLineNC	cterm=none	ctermfg=fg	ctermbg=67	gui=none	guifg=fg	guibg=#afdfff
...
if v:version >= 700
  ...
  hi MatchParen	cterm=none	ctermfg=68	ctermbg=0	gui=bold	guifg=#5f87df	guibg=#000000
