...
6. Troubleshooting                              |snippets_emu-troubleshooting|
...
this if it causes conflicts with other plugins. Doing so will require
remapping in both insert and select modes and can be done with the following
commands: >

    imap <unique> <Your key here> <Plug>Jumper
    smap <unique> <Your key here> i<BS><Your key here>
~
==============================================================================
