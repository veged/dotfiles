...
(function parameters: (formal_parameters ["(" ")"] @punctuation.keyword @punctuation.function.bracket))
(function parameters: (formal_parameters "," @punctuation.keyword @punctuation.function.delimiter))
(function body: (statement_block ["{" "}"] @punctuation.keyword @punctuation.function.bracket))
