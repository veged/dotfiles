...
[[ "$(jq -r '.mcpServers["practicum-mcp"].url' "$claude_user_path")" == "https://practicum-student-mcp-testing.common-stands.praktikum.yandex.ru/mcp" ]] || fail "~/.claude.json practicum-mcp url"
...
[[ "$(jq -r '.mcpServers["practicum-mcp"].url' "$cursor_manifest_path")" == "https://practicum-student-mcp-testing.common-stands.praktikum.yandex.ru/mcp" ]] || fail "unexpected practicum-mcp url"
...
ugrep -Fq '[mcp_servers.practicum-mcp]' "$codex_config_path" || fail "missing practicum-mcp codex block"
ugrep -Fq 'url = "https://practicum-student-mcp-testing.common-stands.praktikum.yandex.ru/mcp"' "$codex_config_path" || fail "missing practicum-mcp url in codex output"
...
[[ "$(jq -r '.mcp["practicum-mcp"].url' "$opencode_config_path")" == "https://practicum-student-mcp-testing.common-stands.praktikum.yandex.ru/mcp" ]] || fail "unexpected opencode practicum-mcp url"
